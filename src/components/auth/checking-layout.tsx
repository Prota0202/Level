...
export const getCharacterStatus = query(async () => {
  "use server";
...
export default function CheckingLayout() {
  const characterStatus = createAsync(() => getCharacterStatus());
  ...
  // Navigation automatique quand le scan est terminé et les données sont chargées
  createEffect(() => {
        ...
        <div class="min-h-screen bg-gray-900 flex flex-col items-center justify-center px-4">
          <div class="max-w-md w-full space-y-12 text-center">
            <div class="text-center">
              <h1 class="text-3xl font-bold text-blue-400 mb-3">Loading...</h1>
              <p class="text-gray-400 mb-6">Please wait while we initialize your session</p>
            </div>
          </div>
        </div>
      }
